...
<<charts3, echo=F, fig.show="hold",message=F, fig.height=4,fig.cap="EV centrality rank reached by families with ($y$ axis) or withoug ($x$ axis) self loops. \\protect\\label{fig:plots3}">>=
