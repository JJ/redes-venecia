...
denominado *Serrata* o cierre [@serata]. Este proceso regulaba el acceso al
...
```{r tabla.reinado}
knitr::kable(head(doges.years[order(-doges.years$years),],n=10),row.names=F,col.names=c("Dogo","Año de comienzo","Años reinado","Dogo nº"))
```
