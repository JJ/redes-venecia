...
<<correlation, echo=F, fig.show="hold", out.width="50%",message=F, fig.cap="Correlation between the number of intra-family marriages and the difference between the EV centrality with and without self-loops. \\protect\\label{fig:correlation}">>=
