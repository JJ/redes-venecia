...
\begin{reply}
  ...
  is now Table 3. We have also changed from an environment that has an itemized
...
\begin{reply}
  For starters, we have added a new Table (Table 4) that summarizes the kind of
