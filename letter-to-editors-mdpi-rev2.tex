...
to act according to its specific interests.
\end{point}
...
\begin{point}
This shift in balance between the extended family and the branch leads to a
branch strategy of limiting marriages in order to save on dowries and direct the
male members toward different career or occupation: some get married, others
develop a political career, and at least one of them takes care of the family
branch business.
\end{point}
