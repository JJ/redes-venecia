...
The main thing is that the application of self loops is mainly limited to models of the spread of information, and not to the analysis of the network itself. This why we have made it the main focus of this paper.
