...
```{r dogos, echo=F, message=F, fig.cap="Representación de la red de matrimonio de las familias de los dogos, con las aristas dimensionadas usando *edge betweenness*"}
...
plot(doges.sn.connected,
     ...
     vertex.label.cex=V(doges.sn.connected)$EV,
     vertex.label.dist=1,
