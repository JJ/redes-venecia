...
<<freight, echo=F, messages=F, fig.pos="h!tb",fig.cap="US freight traffic network. Weight value is not represented in this graph.\\protect\\label{fig:usfreight}">>=
