...
\rev{Nobles were, then, the only class with full rights, and as such} they were moved by commercial as well as political interests \cite{sperling1999paradox}. \rev{For instance,} marriages in the republic of Venice were arranged institutions \cite{cox1995single,cowan2016marriage,brown2021venetian}. \rev{As \cite{brown2021venetian} states:
\begin{quote}
