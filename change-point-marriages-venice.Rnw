...
\rev{As shown again in \cite{raines2013rameau}, the census starts to include (the term generally used for this is {\em aggregate}) new families into the Golden Book of Venetian nobility. Even families of foreign origin \cite{gelder2013gaining} were accepted, provided they paid 100000 ducats and their aggregation accepted by a vote in the Maggior Consiglio. Many new families were added\footnote{\cite{davis1962decline} mentions "127 families added in his Table 1 that summarizes noble and general demographics, and the census in 1696 shows a population that is almost 40\% higher than in the previous entry in 1633} and {\em traditional} families kept declining, creating that diversity in marriages that explains the high entropy. Since aggregation was not immediate, but needed a slow process of search of social status, \cite{raines2006strategie,gelder2013gaining}, that explains also the increase in the number of marriages to non-noble brides: families aspiring to be aggregated managed, through dowries and tactical marrying, to establish good raport with existing noble families, bound to later vote in favor of their aggregation. }

\subsection{Sixth period, from 1684 to the end of the Republic}

The number of marriages reach its lowest value, entropy and percentage of non-patrician marriages are highest. The republic never recovered.
