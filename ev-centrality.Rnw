...
<<correlation, echo=F, fig.show="hold", message=F, fig.cap="Correlation between the EV centrality of Venetian families in the XV century ($x$) and XVI century ($y$). The line indicates the fitted linear model. \\protect\\label{fig:correlation}">>=
...
<<correlation2, echo=F, fig.show="hold", out.width="50%",message=F, fig.cap="Correlation between the number of intra-family marriages and the difference between the EV centrality with and without self-loops. \\protect\\label{fig:correlation2}">>=
