...
The number of marriages reaches the peak, and in fact, as indicated in Section \ref{sec:trend}, the year with the highest number of marriages is found in this period.
