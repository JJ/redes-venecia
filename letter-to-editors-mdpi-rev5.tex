...
\begin{point}
  I also recommend not writing that the Doge was the "president of the Republic"
  (p. 1), this is perhaps a linguistic misunderstanding but I would not want it
  to be read as a historical-political anachronism.
\end{point}

\begin{reply}
  This has already been fixed as requested by another reviewer. Thanks anyway.
\end{reply}

\begin{point}
Having said that, your work is a pioneering contribution in defining
computational and statistical methodologies to historical datasets on Venice and
ushering in, among others, a hopefully large strand of interesting and due
studies.
\end{point}

\begin{reply}
  Thanks a lot! We are really grateful for your feedback, which has contributed
  better to the understanding of the population dynamics and certain points of
