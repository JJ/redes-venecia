...
<<change.point:entropy, echo=F, fig.cap="Family frequency entropy plotted for the matrimonial time series; the green line indicates the change point found previously">>=
library(DescTools)
