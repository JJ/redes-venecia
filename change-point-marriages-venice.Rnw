...
<<histories2.changepoint.meanvar, echo=F, message=F, warning=F, fig.pos="h!t", fig.height=5, fig.cap="Changepoint found by optimal change of mean and variance. Please bear in mind that $x$ value equal to 0 would correspond to the first year in the series, 1398.">>=
library(changepoint)
